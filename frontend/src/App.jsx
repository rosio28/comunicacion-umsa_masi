...
import {
  ...
  AdminDocentesPage, AdminAlumnosPage,
  AdminEgresadosPage, AdminEventosPage,
  AdminConvocatoriasPage, AdminMultimediaPage,
  AdminGaleriaPage, AdminWhatsappPage,
  AdminMallaPage, AdminInstitucionalPage,
  AdminUsuariosPage, AdminTramitesPage,
} from './pages/admin/AdminPages'
import {
  AdminEventoSesionesPage, AdminConveniosPage,
  AdminMallaPageActualizada, EventoSesionesPublicPage,
  ConveniosPublicPage,
} from './pages/admin/NuevosAdminPages'
import AdminTransparenciaPage from './pages/admin/AdminTransparenciaPage'
      ...
      <AuthProvider>
        <BrowserRouter>
          <Routes>
            ...
            <Route path="/admin/transparencia"       element={<RequireAuth><AdminLayout><AdminTransparenciaPage/></AdminLayout></RequireAuth>}/>
            ...
            <Route path="*" element={
              <PublicLayout>
                <div className="section text-center">
                  ...
                  <h1 className="text-2xl font-bold text-gray-700 mb-6">Página no encontrada</h1>
